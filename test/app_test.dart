...
import 'package:FirstSite/components/loot_list_component/loot_list_component.dart';

NgTestFixture<LootListComponent> fixture;
AppPO appPO;

@AngularEntrypoint()
void main() {
  final testBed = new NgTestBed<LootListComponent>();
